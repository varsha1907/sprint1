...
import com.mycompany.web.controller.WelcomeController;
...
class WelcomeWebAppTest {
    ...
    void testRootConfigComponentScanPackages() {
        ...
        assertThat(packages, arrayContaining("com.mycompany"));
    }
    ...
    void testWebConfigComponentScanPackages() {
        ...
        assertThat(componentScan.basePackages(), arrayContaining("com.mycompany.web"));
    }
