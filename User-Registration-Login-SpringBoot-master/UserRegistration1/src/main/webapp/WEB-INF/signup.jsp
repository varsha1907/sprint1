...
<form action="addUser" style="border:1px solid #ccc" method="post">
  <div class="container">
    ...
    <input type="password" placeholder="Enter Password again" name="user_pass1" required>

    <label for="mobile"><b>Mobile</b></label>
    <input type="text" pattern="[0-9]{10}" placeholder="Enter Mobile" name="user_mobile" required>
