...
import com.mycompany.util.WebAppInitializerWrapper;
...
class WebAppConfigTest {
    ...
    void testRootConfigComponentScanPackages() {
        ...
        assertThat(componentScan.basePackages(), arrayContaining("com.mycompany"));
    }
    ...
    void testWebConfigComponentScanPackages() {
        ...
        assertThat(componentScan.value(), arrayContaining("com.mycompany.web"));
    }
